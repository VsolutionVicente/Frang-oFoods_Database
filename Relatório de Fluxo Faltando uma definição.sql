--POntos para ver com a Cilene
--Uma nota com tres itens onde cadas item vai para um centro de Custos

create view VW_FF_VS_Fluxo as
...
where Entradas.Data_movto >= cast((getdate()-10) as date)
...
selct *
select * from tbMovtoFin where Chave_fato = '000514521'
select object_name(object_id),* from sys.columns where name like '%CCusto%'
select * from TBPLANOCONTA 
select
*/
--select * from tbTipoMvEstoque
